...
@section('content')
    <div class="container">
        <div class="d-flex flex-row justify-content-between align-items-center pb-4">
            <h1 class="text-primary">Mis pacientes</h1>
            <div>
                <a href="{{ route('client.myPatient.create') }}" class="btn btn-primary px-4">
                    <span>Crear</span>
                </a>
            </div>
        </div>

        <form method="GET" action="{{ route('client.myPatient.index') }}" class="p-0 pb-3 col-md-6">
                        ...
                        <tr id="patient-{{ $patient->id }}">
                            ...
                            <td id="destroy" colspan="6" class="d-none">
                                <div class="d-flex flex-row justify-content-between align-items-center">
                                    ...
                                    <div class="dialog-destroy-btn">
                                        <form
                                            action="{{ route('client.myPatient.destroy', $patient) }}"
                            ...
                            <td id="restore" colspan="6" class="d-none">
                                <div class="d-flex flex-row justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <form
                                            action="{{ route('client.myPatient.restore', $patient->id) }}"
                                            method="POST"
                                            class="d-inline">
                                            @method('PUT')
                                            @csrf
