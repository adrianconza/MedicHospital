...
@section('content')
    <div class="container">
        <h1 class="text-primary pb-3">Añadir un administrador</h1>
        <form action="{{ route('admin.administrator.store') }}" method="POST" class="form">
            @csrf
            ...
            <div class="form-group col-md-6 p-0">
                ...
                <input id="password" name="password" type="password" required placeholder="Ingresa la contraseña"
